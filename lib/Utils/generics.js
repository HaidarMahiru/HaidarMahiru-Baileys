...
const generateMessageIDV2 = (userId) => {
    ...
    return 'HaidarMahiru#1-' + hash.toString('hex').toUpperCase().substring(0, 18);
};
exports.generateMessageIDV2 = generateMessageIDV2;
// generate a random ID to attach to a message
const generateMessageID = () => 'HaidarMahiru#1-' + (0, crypto_1.randomBytes)(6).toString('hex').toUpperCase();
...
const fetchLatestBaileysVersion = async (options = {}) => {
    const URL = 'https://raw.githubusercontent.com/DannOfficial/Baileys/master/lib/Defaults/baileys-version.json';
    try {
